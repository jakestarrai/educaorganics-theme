  ...
  return {
    theme: {
      src: {
        ...
        styles: {
          main: path.resolve(roots.src, './styles'),
          components: path.resolve(roots.src, './styles/components'),
          sections: path.resolve(roots.src, './styles/section'),
          modules: path.resolve(roots.src, './styles/modules'),
          vendors: path.resolve(roots.src, './styles/vendors'),
        },
