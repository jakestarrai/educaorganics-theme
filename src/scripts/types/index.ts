...
export interface SellingPlanType {
  name: string;
  id: number;
  options: Array<{
    name: number;
...
export interface SellingPlanAllocationType {
  selling_plan: SellingPlanType;
}
...
export interface ButtonType {
  ...
  disabled?: boolean;
  other?: any;
  dataAttribute?: { [key: string]: string };
}
...
export interface CartItem {
  ...
  selling_plan_allocation: SellingPlanAllocationType | null;
  product_id: number;
